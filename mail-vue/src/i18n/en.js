const en = {
    ...
    cfProvider: 'Cloudflare',
    cfProviderTip: 'Use Cloudflare Workers API binding to send emails. Requires send_email binding in wrangler.toml.',
    noCfBinding: 'Cloudflare Email binding not configured. Please add send_email binding in wrangler.toml.',
    oss: 'Object Storage',
    osDomain: 'Domain',
